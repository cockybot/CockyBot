...
//	"contemporary" => '"contemporary fiction"',
	"crime" => '"in the field of" ADJ10 crime',
	"dark" => '"in the field of" ADJ10 dark',
// 	"detective" => 'detective',
// 	"dragon" => 'dragon',
	"drama" => 'drama',
...
//	"literary" => '"literary fiction"',
	"mystery" => 'mystery',
	"mythology" => '"in the field of" ADJ10 mythology',
// 	"non-fiction" => '"non fiction"',
	"novels" => '"novels NOT NEAR graphic"',
	"paranormal" => '"in the field of" ADJ10 paranormal',
	"poetry" => 'poetry',
	"publishing house" => '"books on a variety of topics"',
	"romance" => 'romance',
	"sci-fi" => '"science fiction"',
	"short stories" => '"short stories"',
	"suspense" => '"in the field of" ADJ10 suspense',
